Ext.define('Limero.mqtt.MqttConnectPanel', {
    extend: 'Ext.Panel',
    resizable: true,
    draggable: true,
    bodyPadding: 5,
    ...
    items: [{
        ...
        text: 'T',
        handler: function () {
            Ext.create("Limero.mqtt.MqttGridPanel", {
        ...
        text: 'G',
        handler: function () {
            Ext.create("Limero.mqtt.MqttLineChartPanel", {
                id: "Panel_" + Math.round(Math.random() * 1000),
                renderTo: "mqttPanel"
            });
        }
        ...
        text: 'R',
        handler: function () {
            Ext.create("Limero.mqtt.MqttRealTimePanel", {
                id: "Panel_" + Math.round(Math.random() * 1000),
                renderTo: "mqttPanel"
            });
        }
